...
- Java2, Eclipse 수업 코드는 `docs/JAVA_ECLIPSE.md`를 봅니다.
- WEB_CLOUD, JSP, Servlet, Tomcat 작업은 `docs/JAVA_WEB.md`를 봅니다.
- Kotlin, Android Studio 작업은 `docs/ANDROID.md`를 봅니다.
- JavaScript, 프론트엔드, Node.js 작업은 `docs/JAVASCRIPT.md`를 봅니다.
- GitHub, SourceTree 작업은 `docs/GIT_WORKFLOW.md`를 봅니다.
- 에러 해결은 `docs/DEBUGGING.md`를 봅니다.
- 새 언어와 프로그램을 추가할 때는 `docs/TOOLS_AND_PROGRAMS.md` 형식을 따릅니다.
